...
HD_PWD='g:/baiduyundownload/ch28/ip_repo/adv7511_hdmi_out/adv7511_hdmi_out/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_display.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hdmi_display.tcl
