...
HD_PWD='E:/FPGA_Test/Study/ax7010_pl_hdmi_out_20200308/project_1/project_1.runs/hdmi_display_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_display_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_display_0.tcl
